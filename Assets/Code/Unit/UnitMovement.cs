...
namespace Code.Unit{
    public class UnitMovement : MonoBehaviour, ICharacterController{
        ...
        public void SetInputs( MovementInputsC inputsC){
            ...
            Vector3 cameraPlanarDirection =
                Vector3.ProjectOnPlane(inputsC.CameraRotation * Vector3.forward, Motor.CharacterUp).normalized;
            if (cameraPlanarDirection.sqrMagnitude == 0f){
                cameraPlanarDirection = Vector3.ProjectOnPlane(inputsC.CameraRotation * Vector3.up, Motor.CharacterUp)
                    .normalized;
            }
        ...
        public void OnMovementHit(Collider hitCollider, Vector3 hitNormal, Vector3 hitPoint,
            ...
            if (r){
                Vector3 relativeVel =
                    Vector3.Project(r.velocity, hitNormal) - Vector3.Project(Motor.Velocity, hitNormal);
            }
        }
