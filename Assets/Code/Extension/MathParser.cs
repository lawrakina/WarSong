...
namespace Code.Extension{
    ...
    public class MathParser{
        ...
        public MathParser(){
            try{
                decimalSeparator = Char.Parse(System.Globalization.CultureInfo.CurrentCulture.NumberFormat
        ...
        private StringBuilder
            SyntaxAnalysisInfixNotation(string token, StringBuilder outputString, Stack<string> stack){
