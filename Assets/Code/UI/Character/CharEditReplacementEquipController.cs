...
namespace Code.UI.Character
{
    public sealed class CharEditReplacementEquipController : BaseController
    {
            ...
            base(activate)
        {
            ...
            _cellTemplate = _profilePlayer.Settings.UiViews.TemplateCellClickAndSelectHandler;
        ...
        private void Load(EquipCellType equipCellType, List<TargetEquipCell> targetEquipCells)
        {
            ...
            //запрос надетой вещи
            var equipmentCell = _profilePlayer.CurrentPlayer.UnitEquipment.Cells.FirstOrDefault(x=> x.EquipCellType == equipCellType);
            ...
            if (equipmentCell != null && !equipmentCell.IsEmpty)
            {
                ...
                _listItems.EquippedItem = equippedItem;
            }
        ...
        private void UpdateInfo()
        {
            ...
            if (_listItems.EquippedItem)
            {
                _view.InfoTitleSelectedItem = $"Equipped item: {_listItems.EquippedItem.Body.UiInfo.Title}";
                _view.InfoDescriptionSelectedItem = $"{_listItems.EquippedItem.Body.UiInfo.Description}";
                return;
            }
        ...
        {
            Dbg.Log($"PutOnOrTakeoffItem.SelectItem:{_listItems.SelectedItem}, EquippedItem:{_listItems.EquippedItem}");
            var equip = _listItems.EquippedItem;
